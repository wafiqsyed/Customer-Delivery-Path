...
public class CellColors {
	...
	public static final Color ODD_SWITCH_PUSHED = Color.RED.darker();
	public static final Color EVEN_SWITCH_PUSHED = Color.PINK.darker();
	public static final Color ODD_SWITCH_POPPED = Color.RED.brighter();
	public static final Color EVEN_SWITCH_POPPED = Color.PINK.brighter();
		public static final Color OMNI_SWITCH_PUSHED = Color.GREEN.darker();
	public static final Color OMNI_SWITCH_POPPED = Color.GREEN.brighter();
